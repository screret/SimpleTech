...
public abstract class MultiblockCuboid<T extends MultiblockStructureData> {
    ...
    protected static final MultiblockResult NO_ATTEMPT = MultiblockResult.error(null, new TranslatableComponent("multiblock.simpletech.no_attempt"));
    /** Error if the structure is outside the loaded area */
    protected static final MultiblockResult NOT_LOADED = MultiblockResult.error(null, new TranslatableComponent("multiblock.simpletech.not_loaded"));
    /** Error if the structure is outside the loaded area */
    protected static final MultiblockResult TOO_HIGH = MultiblockResult.error(null, new TranslatableComponent("multiblock.simpletech.too_high"));

    /** Error if the structure inside is not valid */
    protected static final Component INVALID_INNER_BLOCK = new TranslatableComponent("multiblock.simpletech.invalid_inner_block");
    /** Error if the structure inside is not valid */
    protected static final String TOO_LARGE = "multiblock.simpletech.too_large";
    /** Error if a block is invalid in the floor */
    protected static final Component INVALID_FLOOR_BLOCK = new TranslatableComponent("multiblock.simpletech.invalid_floor_block");
    /** Error if a block is invalid in the ceiling */
    protected static final Component INVALID_CEILING_BLOCK = new TranslatableComponent("multiblock.simpletech.invalid_floor_block");
    /** Error if a block is invalid in the walls */
    protected static final Component INVALID_WALL_BLOCK = new TranslatableComponent("multiblock.simpletech.invalid_wall_block");
    /** Error if the structure floor has no frame */
    protected static final Component INVALID_FLOOR_FRAME = new TranslatableComponent("multiblock.simpletech.invalid_floor_frame");
    /** Error if the structure ceiling has no frame */
    protected static final Component INVALID_CEILING_FRAME = new TranslatableComponent("multiblock.simpletech.invalid_ceiling_frame");
    /** Error if the structure wall has no frame */
    protected static final Component INVALID_WALL_FRAME = new TranslatableComponent("multiblock.simpletech.invalid_wall_frame");
    ...
    public T readFromTag(CompoundTag nbt) {
        CompoundTag minTag = nbt.getCompound(MultiblockStructureData.TAG_MIN);
        CompoundTag maxTag = nbt.getCompound(MultiblockStructureData.TAG_MAX);
        BlockPos minPos = NbtUtils.readBlockPos(minTag);
        BlockPos maxPos = NbtUtils.readBlockPos(maxTag);
