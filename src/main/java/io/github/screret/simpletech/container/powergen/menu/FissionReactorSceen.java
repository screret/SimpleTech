...
public class FissionReactorSceen extends AbstractContainerScreen<FissionReactorContainer> {

    private final ResourceLocation GUI = new ResourceLocation(SimpleTech.MOD_ID, "textures/gui/base_gui.png");

    public FissionReactorSceen(FissionReactorContainer container, Inventory inv, Component name) {
