...
public class DecompositionPowergenScreen extends AbstractContainerScreen<DecompositionPowergenContainer> {

    private final ResourceLocation GUI = new ResourceLocation(SimpleTech.MOD_ID, "textures/gui/base_gui.png");

    public DecompositionPowergenScreen(DecompositionPowergenContainer container, Inventory inv, Component name) {
