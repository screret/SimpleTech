package io.github.screret.simpletech.container.menu;
...
public class BaseMachineScreen extends AbstractContainerScreen<BaseMachineContainer> {

    private final ResourceLocation GUI = new ResourceLocation(SimpleTech.MOD_ID, "textures/gui/base_gui.png");

    public BaseMachineScreen(BaseMachineContainer container, Inventory inv, Component name) {
